...
namespace InControl
{
	...
	{
		// Token: 0x060002FB RID: 763 RVA: 0x0001472C File Offset: 0x00012B2C
		...
		// Token: 0x060002FC RID: 764 RVA: 0x0001474A File Offset: 0x00012B4A
		...
		// (get) Token: 0x060002FD RID: 765 RVA: 0x0001476C File Offset: 0x00012B6C
		...
		// (get) Token: 0x060002FE RID: 766 RVA: 0x000147A9 File Offset: 0x00012BA9
		public string Name
		{
			get
			{
		...
		// (get) Token: 0x060002FF RID: 767 RVA: 0x000147CD File Offset: 0x00012BCD
		public Key Key
		{
			get
			{
		...
		public static readonly KeyInfo[] KeyList = new KeyInfo[]
		{
			...
			new KeyInfo(Key.Mouse0, "Left Button", new KeyCode[]
			{
				KeyCode.Mouse0
			}),
			new KeyInfo(Key.Mouse1, "Middle Button", new KeyCode[]
			{
				KeyCode.Mouse1
			}),
			new KeyInfo(Key.Mouse2, "Right Button", new KeyCode[]
			{
				KeyCode.Mouse2
			})
		};
