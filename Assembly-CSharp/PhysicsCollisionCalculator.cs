...
{
	// Token: 0x06001DBC RID: 7612 RVA: 0x00097530 File Offset: 0x00095930
	public static bool DetectCollisions(PhysicsContext context, List<ColliderSegmentReference> segments, Vector2F delta, int mask, List<CollisionData> outCollisions)
	{
		...
		{
			if (PhysicsCollisionCalculator.f__mg_cache0 == null)
			{
				PhysicsCollisionCalculator.f__mg_cache0 = new ListUtil.LessThanDelegate<CollisionData>(PhysicsCollisionCalculator.collisionLessThan);
			}
			ListUtil.Sort<CollisionData>(outCollisions, PhysicsCollisionCalculator.f__mg_cache0);
		}
		return outCollisions.Count > count;
	}

	// Token: 0x06001DBD RID: 7613 RVA: 0x000975EC File Offset: 0x000959EC
	...
	// Token: 0x06001DBE RID: 7614 RVA: 0x00097644 File Offset: 0x00095A44
	public static CollisionData CalculateExtractionWithVelocity(PhysicsContext context, Vector2F direction, List<IPhysicsCollider> colliders, int mask)
	{
		...
		{
			Debug.LogWarning("Ran of out room in sharedRaycasts when attempting to calculate extraction.  Consider increasing size of sharedRaycasts array.  Insufficient space could cause collision errors.");
	...
	// Token: 0x06001DBF RID: 7615 RVA: 0x00097980 File Offset: 0x00095D80
	...
	// Token: 0x06001DC0 RID: 7616 RVA: 0x00097F1C File Offset: 0x0009631C
	...
	// Token: 0x06001DC1 RID: 7617 RVA: 0x00098220 File Offset: 0x00096620
	...
	[CompilerGenerated]
	private static ListUtil.LessThanDelegate<CollisionData> f__mg_cache0;
}
