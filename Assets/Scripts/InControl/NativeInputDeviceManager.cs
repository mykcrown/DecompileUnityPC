...
namespace InControl
{
	...
	{
		private sealed class _DetectDevice_c__AnonStorey0
		{
			internal NativeDeviceInfo deviceInfo;

			internal bool __m__0(NativeInputDeviceProfile profile)
			{
				return profile.Matches(this.deviceInfo);
			}

			internal bool __m__1(NativeInputDeviceProfile profile)
			{
				return profile.Matches(this.deviceInfo);
			}

			internal bool __m__2(NativeInputDeviceProfile profile)
			{
				return profile.LastResortMatches(this.deviceInfo);
			}

			internal bool __m__3(NativeInputDeviceProfile profile)
			{
				return profile.LastResortMatches(this.deviceInfo);
			}
		}
		...
		{
			NativeInputDeviceManager._DetectDevice_c__AnonStorey0 _DetectDevice_c__AnonStorey = new NativeInputDeviceManager._DetectDevice_c__AnonStorey0();
			_DetectDevice_c__AnonStorey.deviceInfo = deviceInfo;
			NativeInputDeviceProfile nativeInputDeviceProfile = null;
			nativeInputDeviceProfile = (nativeInputDeviceProfile ?? this.customDeviceProfiles.Find(new Predicate<NativeInputDeviceProfile>(_DetectDevice_c__AnonStorey.__m__0)));
			nativeInputDeviceProfile = (nativeInputDeviceProfile ?? this.systemDeviceProfiles.Find(new Predicate<NativeInputDeviceProfile>(_DetectDevice_c__AnonStorey.__m__1)));
			nativeInputDeviceProfile = (nativeInputDeviceProfile ?? this.customDeviceProfiles.Find(new Predicate<NativeInputDeviceProfile>(_DetectDevice_c__AnonStorey.__m__2)));
			nativeInputDeviceProfile = (nativeInputDeviceProfile ?? this.systemDeviceProfiles.Find(new Predicate<NativeInputDeviceProfile>(_DetectDevice_c__AnonStorey.__m__3)));
			NativeInputDevice nativeInputDevice = this.FindDetachedDevice(_DetectDevice_c__AnonStorey.deviceInfo) ?? new NativeInputDevice();
			nativeInputDevice.Initialize(deviceHandle, _DetectDevice_c__AnonStorey.deviceInfo, nativeInputDeviceProfile);
		...
		internal static bool Enable()
		{
			...
			{
				UnityEngine.Debug.LogError("Error enabling NativeInputDeviceManager: " + current);
			}
			return false;
		}
	}
