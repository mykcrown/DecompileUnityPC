...
namespace InControl
{
	public class InputManager
	{
		...
		private static Comparison<InputDevice> __f__am_cache0;
		...
		public static void AttachDevice(InputDevice inputDevice)
		{
			...
			if (!InputManager.devices.Contains(inputDevice))
			{
				...
				List<InputDevice> arg_5A_0 = InputManager.devices;
				if (InputManager.__f__am_cache0 == null)
				{
					InputManager.__f__am_cache0 = new Comparison<InputDevice>(InputManager._AttachDevice_m__0);
				}
				arg_5A_0.Sort(InputManager.__f__am_cache0);
			}
		...
		private static int _AttachDevice_m__0(InputDevice d1, InputDevice d2)
		{
